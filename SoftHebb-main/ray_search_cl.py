...
from engine_cl import getActivation, train_sup, train_unsup, evaluate_unsup, evaluate_sup, evaluate_sup_multihead
    ...
    if classes_per_task != -1: 
        ...
        if out_channels >=  classes_per_task or shmh:
            for fold in range(folds):
                ...
                ray_search(params, name_model, dataset_sup_1, dataset_unsup_1, evaluate, results)
