...
class Model:
    ...
    def __init__(self, x, y_):
        ...
        # layer-2
        self.w2 = weight_variable([50, 256])
        self.b2 = weight_variable([256])

        # layer-3
        self.w3 = weight_variable([256, self.out_dim])
        self.b3 = weight_variable([self.out_dim])

        # So, this variable could be used to access weights and biases outside the class!
        self.var_list = [self.w1, self.b1, self.w2, self.b2, self.w3, self.b3]
